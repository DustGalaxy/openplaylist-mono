...
export const filterTabActiveClass =
  'border-accent/60 bg-level-1 text-text-main shadow-[0_0_12px_rgba(245,106,25,0.15)]'

export const filterTabInactiveClass =
  'border-white/5 bg-level-1/30 text-text-secondary hover:border-accent/30 hover:text-text-main'
