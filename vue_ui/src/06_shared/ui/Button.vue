<template>
    <div class="card flex justify-center">
        <Button v-slot="slotProps" asChild>
            <button v-bind="slotProps.a11yAttrs" :class="theme">
                SIGN UP
            </button>
        </Button>
    </div>
...
const { class: className }  = attrs// to ensure attrs are passed down to the button
...
const theme = twMerge(
    `
      ...
      `, attrs.class, `bg-${attrs.theme || 'level-2'}`
)
